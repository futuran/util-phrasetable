...
def draw_heatmap(att_mat, axis_name):
    '''
    ヒートマップ作成関数
    Parameters
    ------------
...
class AllPhrase:
    ...
    def draw_heatmap(self):
        ...
        draw_heatmap(tmp, axis_name=self.input_sentence.split() )
...
def phrasebyphrase(args):
    ...
    print('#phrase_table = {}'.format(len(phrase_table)))

    phrase_table = dict(phrase_table)

    print('translating phrase by phrase...')
    query = "In information technology and electron field , the application of nanotechnology to next generation semiconductors , high @-@ density information record technology , miniature integrated circuit elements , electric power saving displays using carbon nano @-@ tube , etc. can be expected . in information"
